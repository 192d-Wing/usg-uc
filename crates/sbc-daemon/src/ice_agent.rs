...
//! - `sbc-ice` for ICE protocol implementation (RFC 8445)
//! - `sbc-stun` for STUN connectivity checks
//! - `sbc-turn` for TURN relay allocation
//!
//! ## Features
//!
...
use sbc_ice::{Candidate, IceAgent, IceRole};
use sbc_stun::{StunClass, StunMessage};
