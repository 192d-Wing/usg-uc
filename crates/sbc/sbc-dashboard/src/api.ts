...
// Same-origin in production (dashboard served by sbc-daemon, HTTPS :8443 by
// default); the Vite dev server proxies /api (see vite.config.ts).
//
// Auth: the daemon issues an HttpOnly sbc_session cookie on login, sent
