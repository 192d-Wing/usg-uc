...
// until sbc-api accepts credentials, and drops back to login whenever any
// API call returns 401 (session expiry, pod restart with a rotated key).
//
// The session lives in an HttpOnly cookie set by POST /api/v1/auth/login —
